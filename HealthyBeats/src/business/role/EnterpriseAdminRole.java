...
import userinterface.enterpriseradminrole.EnterpriseAdminWorkAreaJPanel;
...
public class EnterpriseAdminRole extends Role {
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, EcoSystem ecoSystem, Network network, Enterprise enterprise, Organization organization, Store store, UserAccount userAccount) {
        return new EnterpriseAdminWorkAreaJPanel(userProcessContainer, ecoSystem, network, enterprise, userAccount);
    }
